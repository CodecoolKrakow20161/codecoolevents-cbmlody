...
INSERT INTO events (name, date, description, categoryID, link) VALUES ('CoolHack', '25/05/2017 09:00', 'Lets test each others creativity!!111oneoneone', 2, 'https://www.google.com/');
INSERT INTO events (name, date, description, categoryID, link) VALUES ('Testing2', '12/05/2017 15:15', 'It''s some "kind" of magic', 3, 'https://www.google.com/');
INSERT INTO events (name, date, description, categoryID, link) VALUES ('Hello Java', '12/05/2017 12:30', 'We''re starting to learn Java, using Atom. Yes Atom. You need to know your shit before you start using that piece of heavy artillery called intelliJ', 3, 'https://www.google.com');
